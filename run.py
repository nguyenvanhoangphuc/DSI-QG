...
class RunArguments:
    ...
    top_k: Optional[int] = field(default=300)
    num_return_sequences: Optional[int] = field(default=300)
    q_max_length: Optional[int] = field(default=32)


def make_compute_metrics(tokenizer, valid_ids):
    def compute_metrics(eval_preds):
        print("vao compute_metrics")
        print("===="*20)
        recall_ks = [1, 2, 3, 5, 7, 10, 20, 50, 100, 200, 500, 600, 700, 743, 800]
        mrr_us = [10, 100]
        map_us = [10, 100]
