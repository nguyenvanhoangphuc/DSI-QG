...
# python3 run.py \
#         --task "DSI" \
#         --model_name "DSI-QG/models/LEGAL-ja-mt5-base-DSI/checkpoint-10000" \
#         --run_name "LEGAL-ja-mt5-base-DSI-Recall" \
#         --max_length 512 \
#         --train_file data/new_legal_data/ja_dsi_ds/train_data_dsi.json \
#         --valid_file data/new_legal_data/ja_dsi_ds/test_data_dsi.json \
#         --output_dir "models/LEGAL-ja-mt5-base-DSI-Recall" \
...
# load checkpoint chạy lại
python3 run.py \
        --task "DSI" \
        --model_name "models/LEGAL-ja-mt5-base-DSI/checkpoint-9000" \
        --run_name "LEGAL-ja-mt5-base-DSI-Recall" \
        --max_length 512 \
        --train_file data/new_legal_data/ja_dsi_ds/train_data_dsi.json \
        --valid_file data/new_legal_data/ja_dsi_ds/test_data_dsi.json \
...
#         --max_length 128 \
#         --train_file data/new_legal_data/ja_dsi_ds/train_data_dsi.json \
#         --valid_file data/new_legal_data/ja_dsi_ds/validation_data_dsi.json \
...
#         --max_length 256 \
#         --valid_file data/new_legal_data/ja_dsi_ds/legal_corpus.tsv \
#         --output_dir temp \
#         --dataloader_num_workers 10 \
#         --report_to wandb \
#         --logging_steps 100 \
